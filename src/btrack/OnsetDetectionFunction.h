...
public:
   ...
   */
  OnsetDetectionFunction(int hopSize_, int frameSize_,
                         int onsetDetectionFunctionType_, int windowType_);

  /** Destructor */
  ~OnsetDetectionFunction();

  /** Initialisation function for only updating hop size and frame size (and not
   * window type or onset detection function type
   * @param hopSize_ the hop size in audio samples
   * @param frameSize_ the frame size in audio samples
   */
...
private:
  ...
  /** Calculate spectral difference (half wave rectified) detection function
   * sample */
  ...
  /** Calculate complex spectral difference detection function sample (half-wave
   * rectified) */
  ...
  //=======================================================================
  std::unique_ptr<FastFourierTransformer> ff_transformer;
